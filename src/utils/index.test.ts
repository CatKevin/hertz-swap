...
import { TokenAmount, Token, ChainId, Percent, JSBI } from 'leekswap-test-sdk'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('enum', () => {
      expect(getEtherscanLink(ChainId.MAINNET, 'abc', 'address')).toEqual('https://bscscan.com/address/abc')
    })
  })
